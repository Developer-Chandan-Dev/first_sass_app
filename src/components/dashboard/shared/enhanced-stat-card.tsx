      ...
      <Link href={getLocalizedPath(href)} className="block">
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          <div className="flex items-center gap-2">
            ...
            <Badge className={cn('text-xs px-1.5 py-0.5 transition-all', statusBadgeColors[status])}>
              {status}
            </Badge>
          </div>
          <div className="flex items-center gap-2">
        ...
        <CardContent className="pb-3">
          <div className="flex items-center justify-between mb-2">
            <div className={cn('text-2xl font-bold truncate transition-all', isHovered && 'text-primary')} title={value}>
              {value}
            </div>
            {extraInfo && (
