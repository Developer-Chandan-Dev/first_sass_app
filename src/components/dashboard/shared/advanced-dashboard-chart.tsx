    ...
    <Card>
      <CardHeader className="pb-3">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mt-4">
          ...
          <div className={`${summary.netTotal >= 0 ? 'bg-blue-50 dark:bg-blue-950' : 'bg-orange-50 dark:bg-orange-950'} p-3 rounded-lg`}>
            <div className="flex items-center gap-2">
              {summary.netTotal >= 0 ? (
            ...
            <p className={`text-xl sm:text-2xl font-bold ${summary.netTotal >= 0 ? 'text-blue-800 dark:text-blue-200' : 'text-orange-800 dark:text-orange-200'} mt-1`}>
