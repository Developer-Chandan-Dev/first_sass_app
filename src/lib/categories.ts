...
export const DEFAULT_CATEGORIES: Category[] = [
  { key: 'food', translationKey: 'expenses.categories.food', icon: '🍽️', isDefault: true },
  { key: 'transport', translationKey: 'expenses.categories.transport', icon: '🚗', isDefault: true },
  { key: 'shopping', translationKey: 'expenses.categories.shopping', icon: '🛍️', isDefault: true },
  { key: 'entertainment', translationKey: 'expenses.categories.entertainment', icon: '🎬', isDefault: true },
  { key: 'bills', translationKey: 'expenses.categories.bills', icon: '💡', isDefault: true },
  { key: 'healthcare', translationKey: 'expenses.categories.healthcare', icon: '🏥', isDefault: true },
  { key: 'education', translationKey: 'expenses.categories.education', icon: '📚', isDefault: true },
  { key: 'travel', translationKey: 'expenses.categories.travel', icon: '✈️', isDefault: true },
  { key: 'other', translationKey: 'expenses.categories.other', icon: '📦', isDefault: true },
];
...
export function getFrontendCategoryKey(backendKey: string): string {
  const entry = Object.entries(BACKEND_CATEGORY_MAP).find(([, value]) => value === backendKey);
