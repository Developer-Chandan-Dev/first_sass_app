...
export function useExpenseTable(expenseType: 'free' | 'budget' = 'free') {
  ...
  const handleDelete = async (id: string, expensesData?: { deleteSuccess?: string }) => {
    ...
    try {
      ...
      console.error('Delete expense error:', sanitizeForLog(error instanceof Error ? error.message : 'Unknown error'));
  ...
  const handleBulkDelete = async () => {
    ...
    try {
      ...
      console.error('Bulk delete error:', sanitizeForLog(error instanceof Error ? error.message : 'Unknown error'));
  ...
  const handleCSVExport = (selectedOnly = false) => {
    ...
    try {
      ...
      console.error('CSV export error:', sanitizeForLog(error instanceof Error ? error.message : 'Unknown error'));
