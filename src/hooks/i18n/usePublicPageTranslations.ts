    ...
    () => ({
      ...
      pages: {
        analytics: {
          ...
          comingSoon: safeTPages(
            'analytics.comingSoon',
            'Analytics Coming Soon'
          ),
          workingOnFeatures: safeTPages(
            'analytics.workingOnFeatures',
            "We're working on advanced analytics features including expense trends, category insights, and detailed reports."
          ),
        },
        budgets: {
          ...
          workingOnFeatures: safeTPages(
            'budgets.workingOnFeatures',
            "We're working on advanced budgets features including expense trends, category insights, and detailed reports."
          ),
        },
        settings: {
          ...
          workingOnFeatures: safeTPages(
            'settings.workingOnFeatures',
            "We're working on advanced settings features including expense trends, category insights, and detailed reports."
          ),
        },
        categories: {
