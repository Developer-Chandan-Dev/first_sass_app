...
import { useBaseTranslations, createSafeTranslator } from './useBaseTranslations';
...
export function usePublicPageTranslations() {
  ...
  return useMemo(() => ({
    ...
    landing: {
      ...
      description: safeTLanding('description', 'Take control of your finances with intelligent expense tracking and budget management.'),
      ...
      nextGeneration: safeTLanding('nextGeneration', 'Experience the next generation of expense tracking'),
      ...
      joinMillions: safeTLanding('joinMillions', 'Join millions of users who have revolutionized their financial management'),
    ...
    features: {
      aiInsights: {
        ...
        description: safeTFeatures('aiInsights.description', 'Machine learning algorithms analyze your spending patterns'),
      },
      predictiveAnalytics: {
        title: safeTFeatures('predictiveAnalytics.title', 'Predictive Analytics'),
        description: safeTFeatures('predictiveAnalytics.description', 'Forecast future expenses and identify savings opportunities'),
      },
      smartCategorization: {
        title: safeTFeatures('smartCategorization.title', 'Smart Categorization'),
        description: safeTFeatures('smartCategorization.description', 'Automatic expense categorization with 99% accuracy'),
      },
      bankSecurity: {
        title: safeTFeatures('bankSecurity.title', 'Bank-Level Security'),
        description: safeTFeatures('bankSecurity.description', 'Enterprise-grade encryption protects your financial data'),
      },
      mobileFirst: {
        title: safeTFeatures('mobileFirst.title', 'Mobile-First Design'),
        description: safeTFeatures('mobileFirst.description', 'Seamless experience across all devices'),
      },
      globalCurrency: {
        title: safeTFeatures('globalCurrency.title', 'Global Currency Support'),
        description: safeTFeatures('globalCurrency.description', 'Track expenses in 150+ currencies'),
      },
    },
    ...
    testimonials: {
      sarah: {
        ...
        content: safeTTestimonials('sarah.content', "TrackWise's AI insights helped me reduce business expenses by 30%."),
      },
      marcus: {
        name: safeTTestimonials('marcus.name', 'Marcus Johnson'),
        role: safeTTestimonials('marcus.role', 'Freelancer'),
        content: safeTTestimonials('marcus.content', 'Finally, an expense tracker that understands my workflow.'),
      },
      emily: {
        name: safeTTestimonials('emily.name', 'Emily Rodriguez'),
        role: safeTTestimonials('emily.role', 'Finance Manager'),
        content: safeTTestimonials('emily.content', "The team collaboration features are incredible."),
      },
    },
    ...
    footer: {
      description: safeTFooter('description', 'The future of expense management. Track, analyze, and optimize your finances.'),
      product: {
    ...
    t,
  }), [baseTranslations, t, safeTLanding, safeTNav, safeTFeatures, safeTPricing, safeTFooter, safeTAuth, safeTTestimonials, safeTPages, safeTStats]);
}