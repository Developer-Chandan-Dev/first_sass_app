...
export function useDashboardTranslations() {
  ...
  return useMemo(() => ({
    ...
    expenses: {
      ...
      budgetExpensesCount: safeTExpenses('budgetExpensesCount', 'Budget Expenses Count'),
    ...
    pages: {
      analytics: {
        ...
        description: safeTDashboard('pages.analytics.description', 'Advanced analytics and insights'),
        comingSoon: safeTDashboard('pages.analytics.comingSoon', 'Coming Soon'),
        workingOnFeatures: safeTDashboard('pages.analytics.workingOnFeatures', "We're working on advanced features"),
      },
      budgets: {
        title: safeTDashboard('pages.budgets.title', 'Budgets'),
        description: safeTDashboard('pages.budgets.description', 'Manage your budgets'),
    ...
    t,
  }), [baseTranslations, t, safeTDashboard, safeTSidebar, safeTExpenses, safeTIncome, safeTTable, safeTStats, safeTAdmin, safeTCurrency, safeTDateFormat, safeTExpenseCards]);
}