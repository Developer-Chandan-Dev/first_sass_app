        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto mb-16">
            {[
              ...
              <Card
                key={index}
                className={`relative ${plan.popular ? 'bg-gradient-to-b from-blue-500/10 to-purple-500/10 border-blue-500/30 scale-105' : 'bg-card border-border'} hover:scale-105 transition-all duration-300`}
              >
                {plan.popular && (
