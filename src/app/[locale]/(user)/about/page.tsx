        ...
        <div className="container mx-auto px-4">
            ...
            {[
              {
                ...
                desc: t('stats.users.desc'),
              },
              {
                icon: <Target className="w-8 h-8" />,
                title: t('stats.ai.title'),
                desc: t('stats.ai.desc'),
              },
              {
                icon: <Award className="w-8 h-8" />,
                title: t('stats.award.title'),
                desc: t('stats.award.desc'),
              },
              {
                icon: <Globe className="w-8 h-8" />,
                title: t('stats.global.title'),
                desc: t('stats.global.desc'),
              },
            ].map((stat, index) => (
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg max-w-none text-muted-foreground">
              <p className="mb-6">{t('story.paragraph1')}</p>
              <p className="mb-6">{t('story.paragraph2')}</p>
